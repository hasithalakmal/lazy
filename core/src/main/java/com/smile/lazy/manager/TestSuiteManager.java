...
public interface TestSuiteManager {
    ...
    void executeTestSuites(LazySuite lazySuite, LazyExecutionData lazyExecutionData, IdDto idDto, String providedTestSuiteName) throws LazyException, LazyCoreException;
