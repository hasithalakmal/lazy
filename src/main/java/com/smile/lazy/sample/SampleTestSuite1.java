...
public class SampleTestSuite1 {
    ...
    public static LazySuite populateSampleTestSuite() {
        ...
        AssertionRule defaultCreateAssertionGroupRule1 = new AssertionRule(DataSourceEnum.RESPONSE_TIME, AssertionOperationEnum.LESS_THAN, new AssertionValue("200", DataTypeEnum.INTEGER, UnitEnum.MILLI_SECONDS));
        AssertionRule defaultCreateAssertionGroupRule2 = new AssertionRule(DataSourceEnum.RESPONSE_CODE, AssertionOperationEnum.EQUAL, new AssertionValue("201", DataTypeEnum.INTEGER));
        AssertionRule defaultCreateAssertionGroupRule3 = new AssertionRule(DataSourceEnum.BODY, AssertionOperationEnum.NOT_NULL);
        ...
        AssertionRule assertionRule2 = new AssertionRule(DataSourceEnum.BODY, AssertionOperationEnum.EQUAL, new BodyValueAssertion("$['accountName']", "Sathara-1577641690"));
