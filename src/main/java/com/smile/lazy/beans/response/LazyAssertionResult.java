...
public class LazyAssertionResult implements Serializable {
    ...
    public LazyAssertionResult(int lazyAssertionResultId, String lazyAssertionResultName, AssertionRule assertionRule, Boolean failed, String responseValue) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(lazyAssertionResultId, lazyAssertionResultDisplayId, lazyAssertionResultName, lazyAssertionResultDescription, active, assertionRule, failed, responseValue);
    }
